...
-- Library init
    ...
    local FontNames = {
        ...
        ["Inter"] = "Inter_28pt-Medium.ttf",
        ["Inter SemiBold"] = "Inter_28pt-SemiBold.ttf",
        ["Open Sans"] = "open-sans-px.ttf",
        ["Monocraft"] = "Monocraft.ttf",
        ["DOS VGA"] = "Perfect DOS VGA 437.ttf",
    }

    local FontIndexes = {"ProggyClean", "Tahoma", "Verdana", "SmallestPixel", "ProggyTiny", "Minecraftia", "Tahoma Bold", "Rubik", "Inter", "Inter SemiBold", "Open Sans", "Monocraft", "DOS VGA"}
