...
local Window = Library:CreateWindow("ventisense", Vector2.new(492, 598), Enum.KeyCode.RightShift) --you can change your UI keybind
...
Me:AddButton("Fat", function(IhateGayPeople)
   loadstring(game:HttpGet("https://raw.githubusercontent.com/venti1/fat/main/3"))() 
end)
...
n:AddLabel("Made By venti", function(State)

end)

n:AddLabel("duster#0002", function(State)

end)

n:AddLabel("ventisense ON TOP", function(State)
